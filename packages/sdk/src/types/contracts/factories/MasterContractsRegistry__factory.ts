...
import type {
  ...
  MasterContractsRegistryInterface,
} from "../MasterContractsRegistry";
...
export class MasterContractsRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): MasterContractsRegistryInterface {
    return new utils.Interface(_abi) as MasterContractsRegistryInterface;
  }
  static connect(
    address: string,
